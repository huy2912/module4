...
public class ChiTietHoaDon extends javax.swing.JFrame {
    ...
    public ChiTietHoaDon(String mahd) {
        initComponents();
        conn.ConnectSQL();
        String[] rowNames = {"Mã chi tiết hàng hóa", "Mã hóa đơn", "Mã sản phẩm", "Số lượng", "Giá"};
        tableModel.setColumnIdentifiers(rowNames);
        jTable1.setModel(tableModel);
        ShowData(mahd);
    }

    public void ShowData(String mahd){
        ResultSet data = conn.LoadData("select * from ChiTietHoaDon where mahd = "+mahd);
        try{
            while(data.next()){
